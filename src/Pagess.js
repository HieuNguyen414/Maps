...
/* eslint-enable */
  ...
  export default class Pagess extends Component {
    render() {
      return (
        <View style={{ flex: 1, backgroundColor: '#263238' }}>
          ...
          <Pages horizontal={false} indicatorPosition='left' indicatorColor='#FF9100' indicatorOpacity={0.54}>
            <Image source={require('./img/b-1.png')} style={imageStyle} />
            <Image source={require('./img/b-2.png')} style={imageStyle} />
            <Image source={require('./img/b-3.png')} style={imageStyle} />
          </Pages>
        </View>
      );
    }
